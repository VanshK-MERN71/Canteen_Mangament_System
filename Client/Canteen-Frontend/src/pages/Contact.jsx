    ...
    <div className="mb-5">
      ...
      <div className="row m-5">
        <div className="col-md-6 p-4 bg-light rounded shadow-sm">
          ...
          <p><FaPhone /> +91 9140409771</p>
          <p><FaEnvelope /> vanshkhanna9140@gmail.com</p>
          <div className="d-flex gap-3 mt-3">
            <a href="#"><FaFacebook className="social-icon" /></a>
            <a href="https://x.com/messages/1902726933357715456-1902726933357715456" target="_blank" rel="noopener noreferrer">
  <FaTwitter className="social-icon" />
</a>
            <a href="https://www.instagram.com/direct/t/17845853870585360/" target="_blank" rel="noopener noreferrer">
  <FaInstagram className="social-icon" />
</a>
            {/* <a href="#"><FaLinkedin className="social-icon" /></a> */}
            <a href="https://www.linkedin.com/in/vansh-khanna-0a092b358/" target="_blank" rel="noopener noreferrer">
